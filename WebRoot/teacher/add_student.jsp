...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="StudentServlet?action=addstu&headmaster=${headmaster}" method="post" id="form1">
    <input type="hidden" name="single" value="不通过" />
    <input type="hidden" name="role" value="学生" />
    <input type="hidden" name="headmaster" value="${headmaster}" />
    <ul >
     <li class="clearfix">
	...
	<input type="text" placeholder="请添加年龄" autocomplete="off" class="input-text Validform_error col-xs-12"  datatype="*6-20" recheck="old" id="old" name="old"/>
     ...
     <li class="clearfix">
	  ...
	  </div><i style="color:red"> &nbsp市+县 例如：郑州市新郑</i>
	 <div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
      ...
      <li class="clearfix">
     <label class="label_name col-xs-3 col-lg-3"><i class="c-red">*</i>默认辅导机构：</label>
      <div class="formControls col-xs-6" > <span class="select-box" >
