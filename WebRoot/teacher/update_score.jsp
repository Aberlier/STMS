...
${msg}
<!--添加分类-->
 <form action="../ScoreServlet?action=admin_update_score&sid=${list[0].sid}" method="post" name="form1" id="form1">
...
function submitClick() {
    $("#form1").submit();
    window.parent.location.href="../ScoreServlet?action=tea_findAllScore&headmaster=${tname}";
