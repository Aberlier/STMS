  ...
  <div class="Sellerber_header apex clearfix" id="Sellerber_header">
   ...
   <div class="r_f Columns_top clearfix">
     <div class="administrator l_f" >
      <span class="user-info" >欢迎你${loginname},${role}</span>
...
<!--左侧-->
  <div class="Sellerber_left menu" id="menuBar">
    ...
    <dl class="nav nav-list" id="menu_list">
     <dt class="shop_index nav_link " ><a href="javascript:void(0)" name="../AdminServlet?action=admin_findbyId&adminname=${loginname}" class="iframeurl" title=""><i class="fa fa-angle-double-right"></i><span class="menu-text">管理员首页</span></a></dt>
     ...
     <dd class="submenu">
       <ul>
         <li class="home"><a href="javascript:void(0)" name="../StudentServlet?action=admin_findAll_baokao&role=${role}&adminname=${loginname}" title="" class="iframeurl"><i class="fa fa-angle-double-right"></i>报考列表</a></li>
       </ul>
     </dd>
  ...
  <dt class="nav_link "><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa fa-desktop"></i><span class="menu-text"> 成绩管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
     <dd class="submenu">
       <ul>
