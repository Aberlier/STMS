 ...
 <div class="add_style">
  <ul>
   <li class="clearfix"><label class="label_name col-xs-3">修改报考年级：&nbsp;&nbsp;</label><span class="cont_style col-xs-9">
				...
				<select class="col-xs-10 col-sm-5" style="width:450px" name="myclass"id="myclass" size="1">
   ...
   <li class="clearfix"><label class="label_name col-xs-3">修改学校：&nbsp;&nbsp;</label><span class="cont_style col-xs-9"><input name="school"id="school" type="text" id="form-field-1" class="col-xs-10 col-sm-5" style="width:450px"value="${list[0].school}"/></span></li>
...
function submitClick() {
    $("#form1").submit();
    window.parent.location.href="../StudentServlet?action=admin_findAll_baokao";
