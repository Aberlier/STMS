...
${msg }
   ...
   <form id="user_info" action="loginServlet?action=adminupdateme&adminname=${list[0].superadminname}" method="post">
    <div class="clearfix">   
        ...
        <label class="col-xs-3 label_name" for="form-field-1">姓名：</label>
         <div class="col-xs-9 line_height1"><input type="text" name="adminname" data-name="真实姓名" id="surname" value="${list[0].superadminname}" class="col-xs-7 text_info" disabled="disabled"></div>         
          </div>
 ...
 <!--修改密码样式-->
 <form action="AdminServlet?action=superadmin_updateme_pass&adminname=${list[0].superadminname}"method="post" id="form2">
