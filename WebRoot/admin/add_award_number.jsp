...
<body>
<!--添加分类-->
 <form action="AdminServlet?action=addAward" method="post" id="form1" name="form1">
   <%--  <input type="hidden" name="sno" value="${list.sno}"/> --%>
<div id="ad_sort" >
 <div class="add_style">
     <ul>
     <li class="clearfix"><label class="label_name col-xs-3">添加奖项：&nbsp;&nbsp;</label><span class="cont_style col-xs-9"><input name="award" type="text" id="award" class="col-xs-10 col-sm-5"/></span></li>
