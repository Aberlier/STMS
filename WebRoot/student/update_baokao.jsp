 ...
 <div class="add_style">
  <ul>
   ...
   <li class="clearfix"><label class="label_name col-xs-3">修改学校：&nbsp;&nbsp;</label><span class="cont_style col-xs-9"><input name="school" type="text" id="form-field-1" class="col-xs-10 col-sm-5" style="width:450px"value="${list[0].school}"></span></li>
     ...
     <li class="clearfix"><label class="label_name col-xs-3">修改辅导教师：&nbsp;&nbsp;</label><span class="cont_style col-xs-9">
     <select class="col-xs-10 col-sm-5" style="width:450px" name="fudaoteacher" size="1">
					<option>${list[0].fudaoteacher}</option>
    ...
    <li class="clearfix"><label class="label_name col-xs-3">修改意向院校：&nbsp;&nbsp;</label><span class="cont_style col-xs-9"><input name="intentionalschool" value="${list[0].intentionalschool}"type="text" id="form-field-1" class="col-xs-10 col-sm-5" style="width:450px"></span></li>
   
    <li class="clearfix" style="margin-left:250px"><span class="cont_style col-xs-9"><input  value="保存"type="submit" id="form-field-1" class="" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input name="spwd" value="重置"type="reset" id="form-field-1" class="" ></span></li>
